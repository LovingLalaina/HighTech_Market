    ...
    <body>
        ...
        <section style="margin-bottom:200px;" class="SectionAvecAside">
	        ...
	        <article class="container form-signin">
		        <form method="POST" action="MaterielClient" name="FormulaireChoix">
		        	<fieldset>
			        	<label for="NumeroNom">Numero ou Nom de client : </label>
			        	<input type="text" name="NumeroNom" value="${ sessionScope.UtilisateurActuel.nom }" required/><br/>
		        	</fieldset>
		            <fieldset><h6>Choisissez une des possibilités :</h6></fieldset>
		            <fieldset>
